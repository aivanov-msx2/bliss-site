...
export default function NavLink({ href, active, children }) {
    return (
        <Link
            ...
            className={
                active
                    ? "inline-flex items-center px-1 pt-1 border-b-2 border-red-400 text-base font-medium leading-5 text-gray-900 focus:outline-none focus:border-red-700 transition duration-150 ease-in-out"
