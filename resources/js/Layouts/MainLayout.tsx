                    ...
                    <div className="flex justify-between h-20 grow">
                        <div className="flex grow">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex grow justify-end">
                                ...
                                <a href="https://store.blisswineconcierge.com/Wines/Browse-by-Country/Australia/Castagna" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-base font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                    Featured This Month
                                </a>
